 ...
 *
 * <p>"Customer ID","Customer Name","Gender","Address","Contact Number","Email"
...
public class CsvFileGenerator {
  ...
  public static List<List<String>> generateDataTables(int rows) {
    ...
    for (int i = 0; i < rows; i++) {
      ...
      String email =
          name + "@" + GenUtil.oneOf("gmail.com", "yahoo.com", "hotmail.com", "outlook.com");
  ...
  public static void generateCustomerCsvFiles(int numOfFiles, Path dest)
