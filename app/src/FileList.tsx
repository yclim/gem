...
import ruleService, {Group, GroupFiles, File} from "./api";
    ...
    return (
        <div className="files-section">
            <div className="file-list">
                <Table numRows={files.length} defaultColumnWidth={320} selectionModes={SelectionModes.ROWS_AND_CELLS} onSelection={handleSection}>
                    <Column name="Matched filenames" cellRenderer={cellRenderer}/>
                </Table>
            </div>
            <div className="file-details">
                <Tabs id="TabsExample" selectedTabId={activeTab} onChange={handleNavbarTabChange}>
                    <Tab id="raw" title="File Details" panel={renderRawText()} />
                    <Tab id="meta" title="Tika Metadata" panel={(<div>
                        <table className="bp3-html-table bp3-html-table-striped keyval-table">
                            <thead>
                            <tr>
                                <th>Metadata Key</th>
                            ...
                            <tr>
                                ...
                                <td>53616c7465645f5f2368da84ca932841b336ac1a49edb1a93fae938b8db2cb3ec9cc4dc28d7383f1</td>
                            </tr>
                            <tr>
                                <td>Image Width</td>
                                <td>4000 pixels</td>
                    ...
                    </div>)} panelClassName="ember-panel" />
                    <Tab id="tika" title="Tika Content" panel={
